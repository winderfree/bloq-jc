 ...
 */
// Mi Autoria setup
export const JUAN: IAuthor = {
    name: "Juan S. Casado L.",
    designation: "Software Engineer",
    bio: "I am a Software Engineer from the Dominican Republic, I studied at the UASD.",
    profilePic: "",
     social: [
        {
            icon: <AiFillGithub />,
            link: 'https://github.com/winderfree'
        },
        {
            icon: <AiFillLinkedin />,
            link: 'https://www.linkedin.com/in/juan-casado-luna/'
        },
    ]
}
...
export const WEBSITE_NAME: string = 'Blog Juan S. Casado L.';
...
export const PRIMARY_NAV: iNavSetup = {
    ...
    navLinks: [
        ...
        {
            label: 'Github Repo',
            path: 'https://github.com/winderfree',
            newTab: true
        },
        {
            label: 'Contact Us',
    ...
    socials: [
        {
            link: 'https://www.facebook.com/john0096/',
            icon: <AiFillFacebook />
        },
        {
            link: 'https://www.instagram.com/winderjcfree/',
